...
import { Platform, ImageBackground, ScrollView,Text, TextInput, TouchableOpacity,KeyboardAvoidingView, TouchableWithoutFeedback,StyleSheet,Keyboard,View } from 'react-native'
...
const ChatScreen = ({route,navigation}) => {
    ...
    const {user1,name1,photoURL1,name2,user2,photoURL2} = route.params;
    ...
    useEffect(()=>{
        ...
        .then(res=>{
            if(res.data.exists){
                ...
                axios.post('http://10.0.2.2:5000/drroom/create',{
                    username1: user1,
                    name1: name1,
                    username2: user2,
                    name2: name2,
            ...
            headerLeft: () => (
                <View style={{marginLeft: 10, flexDirection:"row"}}>
                    ...
                    <TouchableOpacity style={{marginLeft: 20, flexDirection:"row"}} activeOpacity={0.5}>
                      <Avatar rounded source={{ uri: photoURL2}} />
                    </TouchableOpacity>
                </View>
            ),
            headerRight:() => (
